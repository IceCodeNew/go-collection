...
ARG CADDY_VERSION=388c7e898c6cbcddd2c59e8a902238a0b4f06857
...
ARG caddy_l4_latest_commit_hash=5764d700c21c290a145dbc0198142ca49ace71b6
...
ARG shfmt_latest_commit_hash=57b7613429b5ac2918c3218f321107f567ba2165
RUN source "/root/.bashrc" \
    && go env -w CGO_ENABLED=0 \
    && go env -w GO111MODULE=on \
    && go env -w GOAMD64=v2 \
...
ARG croc_latest_commit_hash=917d9f16b44a19b7f8f35a7b45dd5be38718b8d4
WORKDIR '/go/src/croc'
RUN source "/root/.bashrc" \
    && go env -w CGO_ENABLED=0 \
    && go env -w GO111MODULE=on \
